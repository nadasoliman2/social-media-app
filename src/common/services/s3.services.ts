import {ListObjectsV2Command, ListObjectsV2CommandOutput, DeleteObjectsCommand, DeleteObjectCommand, GetObjectCommand, ObjectCannedACL, S3Client, PutObjectCommand } from "@aws-sdk/client-s3";
...
const keys = listedObjects.Contents?.map(({ Key }) => ({ Key: Key! })) || [];
